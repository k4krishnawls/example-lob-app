...
namespace ELA.App.StartupConfiguration
{
    public class LocalDevelopmentTasks
    {
        ...
        internal static void StartFrontendService(ISpaBuilder spaBuilder, string workingDirectory, string exeToRun, Func<int, string> commandFromPort, string textForServerStart)
        {
            ...
            // using 127.0.0.1 instead of localhost, localhost has occasional 2 second delays in load times + haven't identified root cause
            //  did see a comment referencing this in ASP.Net issues somewhere afterwards but this works
